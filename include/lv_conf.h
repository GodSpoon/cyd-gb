 ...
 *LV_DITHER_GRADIENT implies LV_DITHER_ERROR_DIFFUSION = 1*/
 ...
 *For scalar draw unit, the index is always 0. */
...
#define LV_USE_API_EXTENSION_V8 1
...
#define LV_USE_LIST       1   /*Requires: lv_btn, lv_label, (lv_img optionally for icons )*/
#define LV_USE_MSGBOX     1
#define LV_USE_ROLLER     1   /*Requires: lv_label*/
#define LV_USE_SLIDER     1   /*Requires: lv_bar*/
#define LV_USE_SPAN       1   /*Requires: lv_label*/
#define LV_USE_SPINBOX    1   /*requires: lv_btn, lv_label*/
...
/*Use X11 to open a window on Linux desktop and handle mouse and keyboard*/
#define LV_USE_X11              0
#define LV_X11_DIRECT_EXIT      1    /*Exit the application when all X11 windows have been closed*/
#define LV_X11_DOUBLE_BUFFER    1    /*Use double buffers to avoid tearing*/

/*Driver for /dev/fb*/
#define LV_USE_LINUX_FBDEV      0
#if LV_USE_LINUX_FBDEV
    #define LV_LINUX_FBDEV_BSD           0
    #define LV_LINUX_FBDEV_RENDER_MODE   LV_DISPLAY_RENDER_MODE_PARTIAL   /*LV_DISPLAY_RENDER_MODE_DIRECT/PARTIAL*/
    #define LV_LINUX_FBDEV_BUFFER_COUNT  0                                /*0: Auto manage buffers, >=1: Manually set number of buffers */
    #define LV_LINUX_FBDEV_BUFFER_SIZE   0                                /*0: Auto set buffer size, >=1: Manually set buffer size in bytes */
#endif

/*Use Nuttx to open a window and handle touchscreen*/
#define LV_USE_NUTTX    0
    ...
    #if LV_USE_NUTTX_LCD
        #define LV_NUTTX_LCD_BUFFER_COUNT    0  /*0: Auto manage buffers, >=1: Manually set number of buffers */
        #define LV_NUTTX_LCD_BUFFER_SIZE     0  /*0: Auto set buffer size, >=1: Manually set buffer size in bytes */
    #endif
